      ...
      children: [
        ...
        ...[
          ...
          (
            Icons.code,
            'Python / Flask',
            'REST API with Blueprints & JWT',
            const Color(0xFF3776AB),
          ),
          (
            Icons.storage,
            'MySQL',
            '28-table relational database',
            const Color(0xFFF29111),
          ),
          (
            Icons.psychology,
            'Gemini AI',
            '7 career coaching tool modes',
    ...
    child: Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            label,
            style: TextStyle(color: AppColors.textMuted(isDark), fontSize: 10),
            textAlign: TextAlign.center,
          ),
        ],
      ),
