...
class _QuestionnaireScreenState extends State<QuestionnaireScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      try {
        await up.updateJobSeekerProfile(f);
      } catch (_) {}
  ...
  Widget _label(String t, bool d) => Padding(
  ...
  Widget _subtitle(String t, bool d) => Padding(
    padding: const EdgeInsets.only(bottom: 14),
    child: Text(
      t,
      style: TextStyle(fontSize: 13, color: AppColors.textMuted(d)),
    ),
  );

  InputDecoration _dec(String h, bool d) => InputDecoration(
    hintText: h,
    hintStyle: TextStyle(color: AppColors.textMuted(d), fontSize: 13),
    filled: true,
    fillColor: AppColors.inputFill(d),
  ...
  Widget _buildStep1(bool d) => Form(
    key: _step1Key,
    child: Column(
  ...
  Widget _buildStep2(bool d) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      ...
      Wrap(
        ...
        children: _allInterests.map((interest) {
          ...
          return FilterChip(
            ...
            side: BorderSide(
              color: sel ? AppColors.primaryCyan : AppColors.border(d),
              width: sel ? 1.5 : 1,
            ),
  ...
  Widget _buildStep3(bool d) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
  ...
  Widget _buildStep4(bool d) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      _label('Job Type', d),
      DropdownButtonFormField<String>(
  ...
  Widget _currentStep(bool d) {
    switch (_step) {
      case 0:
        return _buildStep1(d);
      case 1:
        return _buildStep2(d);
      case 2:
        return _buildStep3(d);
      default:
        return _buildStep4(d);
    }
  }
