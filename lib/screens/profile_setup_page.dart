  ...
  Future<void> _finish() async {
    ...
    try {
      ...
      await ApiService.setupProfile(
          token: token, fullName: _nameController.text.trim(), dob: dob, role: _selectedRole);
      if (!mounted) return;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: GestureDetector(
                ...
                child: Stack(children: [
                  CircleAvatar(
                    ...
                    child: _image == null
                        ? const Icon(Icons.person, color: AppColors.primaryCyan, size: 50)
                        : null,
                  ),
                  Positioned(
                    bottom: 4, right: 4,
            ...
            Center(child: Text('Tap to upload profile picture',
                style: TextStyle(color: Colors.white.withOpacity(0.5)))),
            const SizedBox(height: 30),
            TextFormField(
              controller: _nameController,
              style: const TextStyle(color: Colors.white),
              decoration: buildInputDecoration(icon: Icons.person_outline, label: 'Full Name'),
            ),
            ...
            TextFormField(
              ...
              decoration: buildInputDecoration(
                  icon: Icons.calendar_today_outlined, label: 'Date of Birth'),
            ),
            ...
            Row(children: [
              Expanded(child: _RoleCard(
                icon: Icons.search_rounded, title: 'Job Seeker',
              ...
              Expanded(child: _RoleCard(
                icon: Icons.school_outlined, title: 'Mentor',
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: selected ? AppColors.primaryCyan.withOpacity(0.12) : Colors.white.withOpacity(0.05),
        borderRadius: BorderRadius.circular(18),
        border: Border.all(
          color: selected ? AppColors.primaryCyan : Colors.white.withOpacity(0.12),
          width: selected ? 2 : 1),
      ),
      child: Column(children: [
        Icon(icon, color: selected ? AppColors.primaryCyan : Colors.white.withOpacity(0.5), size: 32),
